...
model_dict = {
    ...
    "protectli-ap2110": "AP2110",
    "protectli-vp2410": "VP2410",
    "protectli-vp2410e": "VP2410E",
    "protectli-vp2420": "VP2420",
    "protectli-vp2420e": "VP2420E",
    "protectli-vp2430": "VP2430",
    "protectli-vp2430e": "VP2430E",
    "protectli-vp2440": "VP2440",
    "protectli-vp2440e": "VP2440E",
    "protectli-vp2445": "VP2445",
    "protectli-vp3210": "VP3210",
    "protectli-vp3210e": "VP3210E",
    "protectli-vp3230": "VP3230",
    "protectli-vp3230e": "VP3230E",
...
class RobotRTE:
    ...
    def rte_check_power_led(self):
        ...
        if self.rte.dut_data.pwr_led.polarity == "active low":
            if state == "high":
                state = "low"
            else:
                state = "high"
