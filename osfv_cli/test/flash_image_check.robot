...
Test Flash Check - No ME in image
    ...
    ...    ${MECHECK_NO_ME_URL}
    Should Contain    ${cli_check_out.stderr}    flash_image_check failed.
...
Test Flash Check - Complete image
    ...
    Should Contain    ${cli_check_out.stdout}    SUCCESS: region "me" is present and contains some data.
    Should Contain    ${cli_check_out.stdout}    OK
